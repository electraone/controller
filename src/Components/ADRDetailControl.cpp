...
ADRDetailControl::ADRDetailControl(const Control &control,
                                   MainDelegate &newDelegate)
    : ADRControl(control, newDelegate)
{
}

void ADRDetailControl::onTouchUp([[maybe_unused]] const TouchEvent &touchEvent)
{
...
void ADRDetailControl::onTouchLongHold(
    [[maybe_unused]] const TouchEvent &touchEvent)
{
}

void ADRDetailControl::onPotTouchUp([[maybe_unused]] const PotEvent &potEvent)
{
    if (!delegate.isDetailLocked()) {
        delegate.closeDetail();
    }
...
void ADRDetailControl::paint(Graphics &g)
{
